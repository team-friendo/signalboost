...
`,
    requestsClosed: `¡SignalBoost está en capacidad! Hemos agregado su solicitud de canal a nuestra lista de espera.
    
Cuando la capacidad se libera, se creará su canal y recibirá un mensaje de bienvenida.

Mientras tanto, no dude en escribirnos en este número con cualquier pregunta! 🖤✨🖤`,
...
invitaciones pendientes: ${getInvites(channel).length}
...
Admin con número ${adminPhoneNumber} se ha eliminado de este canal porque su número de seguridad cambió.
...
${
  ...
  safetyNumberChanged:
    '¡Hola! Parece que tu número de seguridad acaba de cambiar (probablemente porque reinstalaste Signal). Si acaba de enviar un mensaje, vuelva a enviarlo.',
